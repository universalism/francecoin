...
public:
	...
	genesis = CreateGenesisBlock(1502132284, 1775362, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x27c9e1692048aed6ca8afd0ce49875a94baf2891bbfc27fd19086022657089e3"));
        ...
        vSeeds.emplace_back("napoleon.francecoin.org", true);
        ...
        chainTxData = ChainTxData{
            ...
            1502132284, // * UNIX timestamp of last known number of transactions
